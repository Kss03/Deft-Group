...
function ProductCard({data}) {
    ...
    const specArr = specifications.map( (item) => {
        const imgPath = eval(item.img);
        return (
            <small className="spec text-muted me-3" key={item.img + item.spec}>
                <img src={imgPath} alt={item.img} className="me-1"/>
                <span>{item.spec}</span>
            </small>
        )
    })
        ...
        <div className="product-card">
            <div className="card h-100 border-0 overflow-hidden shadow-sm">
                ...
                <div className="card-body position-relative px-xl-4 py-xl-4">
                    ...
                    <div className="d-flex flex-nowrap align-items-xl-center align-items-start justify-content-xl-between flex-xl-row flex-column justify-content-start">
                    ...
                    <div className="like-image position-absolute">
